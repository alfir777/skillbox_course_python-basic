...
message = message + ' ' + secret_message[1][9:13]
message = message + ' ' + secret_message[2][5:15:2]
message = message + ' ' + secret_message[3][12:6:-1]
message = message + ' ' + secret_message[4][20:15:-1]
print(message)
